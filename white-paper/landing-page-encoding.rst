...
.. code-block:: JSON
    :caption: representation in JSON-LD of the NERC example of table 4.1.
...
.. code-block:: turtle
    :caption: representation in Turtle Terse RDF of the NERC example
	      of table 4.1 that was generated by a JSON-LD to RDF
	      converter from the JSON-LD in snippet 10.1.
